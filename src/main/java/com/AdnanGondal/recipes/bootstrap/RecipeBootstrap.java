package com.AdnanGondal.recipes.bootstrap;

import com.AdnanGondal.recipes.models.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    //get optionals
        ...
        tacosRecipe.addIngredient(new Ingredient("Dried Cu min", new BigDecimal(1), teapoonUom));
